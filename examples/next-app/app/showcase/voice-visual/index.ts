...
import { colorFromName, type VoiceMeta } from "./features"
import { type VoiceCfg } from "./renderer"

export { colorFromName, nameToFeatures, type VoiceMeta } from "./features"
export { featuresToColor, type VoiceColor, type VoiceFeatures } from "./color"
export { createVoiceAnimation, type VoiceCfg, type AnimationHandle } from "./renderer"
